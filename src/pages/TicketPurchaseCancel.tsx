...
export const TicketPurchaseCancel = () => {
        ...
        >
          <div className="bg-slate-800/40 backdrop-blur-xl border border-slate-700/40 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/20 text-center">
            ...
            <p className="text-slate-400 text-sm mb-8">
              No se realizó ningún cargo. Puedes volver a intentar cuando
              quieras.
            </p>
            <div className="flex flex-col sm:flex-row items-center gap-3">
              {movieId && (
                <Link
                  to={`/movie/${movieId}/tickets`}
                ...
                >
                  <Ticket size={18} />
                  <span className="text-sm">Elegir de nuevo</span>
                </Link>
              )}
              <Link
                to="/"
